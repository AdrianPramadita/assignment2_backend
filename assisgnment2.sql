...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-07-05 09:35:56',NULL),('diagnostics.include_raw','OFF','2021-07-05 09:35:56',NULL),('ps_thread_trx_info.max_length','65535','2021-07-05 09:35:56',NULL),('statement_performance_analyzer.limit','100','2021-07-05 09:35:56',NULL),('statement_performance_analyzer.view',NULL,'2021-07-05 09:35:56',NULL),('statement_truncate_len','64','2021-07-05 09:35:56',NULL);
...
-- Dump completed on 2021-08-18 21:30:02
-- MySQL dump 10.13  Distrib 8.0.25, for Win64 (x86_64)
--
-- Host: localhost    Database: assisgnment2
-- ------------------------------------------------------
-- Server version	8.0.25
...
INSERT INTO `migrations` VALUES (5,'2014_10_12_000000_create_users_table',1),(7,'2019_08_19_000000_create_failed_jobs_table',1),(10,'2014_10_12_100000_create_password_resets_table',2);
...
CREATE TABLE `pemasukans` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pemasukans_email_unique` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'siadmin','adrian@gmail.com',NULL,'Adrian52','admin',NULL,'2021-07-28 06:44:43','2021-07-28 06:44:43'),(2,'siowner','siowner@gmail.com',NULL,'owner52','owner',NULL,'2021-07-28 06:44:43','2021-07-28 06:44:43');
